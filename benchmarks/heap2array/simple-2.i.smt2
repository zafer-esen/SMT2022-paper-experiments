...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main29 var8 var7 var6 var5) (= var0 0)) (= var1 var5)) (= var2 var6)) (= var4 var7)) (= var3 (writeHeap var8 var5 (O_node (node (h (getnode (readHeap var8 var5))) 0))))) (is-O_node (readHeap var8 var5))) (is-O_node (readHeap var8 var5))) (= var4 nullAddr))) (inv_main0 var3 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main34 var9 var8 var7 var6) (= var0 0)) (= var5 (n (getnode (readHeap var9 var6))))) (= var1 var6)) (= var2 var7)) (= var3 var8)) (= var4 var9)) (is-O_node (readHeap var9 var6))) (= var5 nullAddr))) (inv_main0 var4 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main19 var4 var3 var2 var1) (= var0 (writeHeap var4 var1 (O_node (node (h (getnode (readHeap var4 var1))) var2))))) (is-O_node (readHeap var4 var1))) (is-O_node (readHeap var4 var1)))) (inv_main26 var0 var3 var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (and (and (and (and (and (and (inv_main29 var7 var6 var5 var4) (= var0 var4)) (= var1 var5)) (= var3 var6)) (= var2 (writeHeap var7 var4 (O_node (node (h (getnode (readHeap var7 var4))) 0))))) (is-O_node (readHeap var7 var4))) (is-O_node (readHeap var7 var4))) (not (= var3 nullAddr)))) (inv_main33 var2 var3 var1 var3))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (and (and (and (and (and (and (inv_main34 var8 var7 var6 var5) (= var4 (n (getnode (readHeap var8 var5))))) (= var0 var5)) (= var1 var6)) (= var2 var7)) (= var3 var8)) (is-O_node (readHeap var8 var5))) (not (= var4 nullAddr)))) (inv_main33 var3 var2 var1 var4))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (and (and (and (and (and (and (inv_main33 var8 var7 var6 var5) (= var4 (h (getnode (readHeap var8 var5))))) (= var0 var5)) (= var1 var6)) (= var2 var7)) (= var3 var8)) (is-O_node (readHeap var8 var5))) (not (= var4 1)))) (inv_main35 var3 var2 var1 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Int) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (and (and (and (and (and (and (inv_main33 var8 var7 var6 var5) (= var4 (h (getnode (readHeap var8 var5))))) (= var0 var5)) (= var1 var6)) (= var2 var7)) (= var3 var8)) (is-O_node (readHeap var8 var5))) (= var4 1))) (inv_main34 var3 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main13 var4 var3 var2 var1) (= var0 (writeHeap var4 var1 (O_node (node 1 (n (getnode (readHeap var4 var1)))))))) (is-O_node (readHeap var4 var1))) (is-O_node (readHeap var4 var1)))) (inv_main29 var0 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main33 var3 var2 var1 var0) (not (is-O_node (readHeap var3 var0)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (inv_main35 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main34 var3 var2 var1 var0) (not (is-O_node (readHeap var3 var0)))))))
