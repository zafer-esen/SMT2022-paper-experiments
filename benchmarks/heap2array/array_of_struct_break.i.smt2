...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (batchAllocPostHeap emptyHeap var3 (O_S (S 0)) 100000) (and true (= var2 (AddrRange (ite (<= 0 99999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 100000))))) (inv_main4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap) (var5 Int) (var6 Int) (var7 AddrRange) (var8 Heap)) (or (not (and (and (and (and (and (and (and (inv_main11 var8 var7 var6 var5) (= var0 (+ var2 1))) (= var1 var5)) (= var2 var6)) (= var3 var7)) (= var4 (writeHeap var8 (nthAddrRange var7 var6) (O_S (S 10))))) (is-O_S (readHeap var8 (nthAddrRange var7 var6)))) (is-O_S (readHeap var8 (nthAddrRange var7 var6))))) (inv_main8 var4 var3 var0 var1))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (and (inv_main8 var4 var3 var2 var1) (= var0 0)) (not (<= 0 (+ (+ (* (- 1) var2) 100000) (* (- 1) 1)))))) (inv_main15 var4 var3 var0 var1))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (and (and (inv_main8 var4 var3 var2 var1) (= var0 0)) (<= 0 (+ (+ (* (- 1) var2) 100000) (* (- 1) 1)))) (<= 0 (+ (+ (* (- 1) 5) var1) (* (- 1) 1))))) (inv_main15 var4 var3 var0 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (and (and (inv_main15 var4 var3 var2 var1) (= var0 (+ var2 1))) (<= 0 (+ (+ (* (- 1) var2) 100000) (* (- 1) 1)))) (not (<= 0 (+ 5 (* (- 1) var1)))))) (inv_main15 var4 var3 var0 var1))))
