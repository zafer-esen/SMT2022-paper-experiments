...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (or (not (and (= var2 emptyHeap) (= var1 nullAddr))) (inv_main4 var2 var0 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 node) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (and (and (and (and (and (and (inv_main4 var9 var8 var7) (= var0 1)) (not (= var1 0))) (= var6 (newAddr (allocHeap var9 (O_node var4))))) (= var2 var7)) (= var3 var8)) (= var5 (newHeap (allocHeap var9 (O_node var4))))) (= var6 nullAddr))) (inv_main13 var5 var6 var2 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (and (and (inv_main10 var3 var2 var1) (= var0 (writeHeap var3 var2 (O_node (node 1 (n (getnode (readHeap var3 var2)))))))) (is-O_node (readHeap var3 var2))) (is-O_node (readHeap var3 var2)))) (inv_main17 var0 var2 var1))))
