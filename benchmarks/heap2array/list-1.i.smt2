...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Int) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main51 var9 var8 var7 var6) (= var0 0)) (= var5 (h (getnode (readHeap var9 var6))))) (= var1 var6)) (= var2 var7)) (= var3 var8)) (= var4 var9)) (is-O_node (readHeap var9 var6))) (= var5 3))) (inv_main0 var4 var0))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Addr) (var7 node) (var8 Heap) (var9 Heap) (var10 Addr) (var11 Addr) (var12 Addr) (var13 Addr) (var14 Heap)) (or (not (and (and (and (and (and (and (and (and (and (and (and (and (and (inv_main30 var14 var13 var12 var11) (= var0 1)) (= var1 var11)) (= var3 var12)) (= var5 var13)) (= var8 (writeHeap var14 var11 (O_node (node 2 (n (getnode (readHeap var14 var11)))))))) (is-O_node (readHeap var14 var11))) (is-O_node (readHeap var14 var11))) (= var10 (newAddr (allocHeap var8 (O_node var7))))) (= var2 var1)) (= var4 var3)) (= var6 var5)) (= var9 (newHeap (allocHeap var8 (O_node var7))))) (= var10 nullAddr))) (inv_main38 var9 var6 var10 var2 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main35 var4 var3 var2 var1) (= var0 (writeHeap var4 var1 (O_node (node (h (getnode (readHeap var4 var1))) var2))))) (is-O_node (readHeap var4 var1))) (is-O_node (readHeap var4 var1)))) (inv_main42 var0 var3 var2 var1))))
