...
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Addr) (var4 Addr) (var5 Int) (var6 Int) (var7 Heap)) (or (not (and (and (and (inv_main50 var7 var6 var5 var4 var3 var2 var1) (= var0 (+ var2 1))) (= var5 (data (getnode (readHeap var7 var3))))) (is-O_node (readHeap var7 var3)))) (inv_main47 var7 var6 var5 var4 var1 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Int) (var4 Addr) (var5 Int) (var6 Int) (var7 Heap) (var8 Addr) (var9 Int) (var10 Int) (var11 Addr) (var12 Int) (var13 Int) (var14 Heap)) (or (not (and (and (and (and (and (and (and (and (and (and (inv_main44 var14 var13 var12 var11 var10 var9 var8) (= var0 0)) (= var1 var8)) (= var2 var9)) (= var3 var10)) (= var4 var11)) (= var5 var12)) (= var6 var13)) (= var7 (writeHeap var14 var8 (O_node (node (data (getnode (readHeap var14 var8))) var11))))) (is-O_node (readHeap var14 var8))) (is-O_node (readHeap var14 var8)))) (inv_main47 var7 var6 var5 var1 var1 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap)) (or (not (and (and (inv_main49 var6 var5 var4 var3 var2 var1) (= var0 (next (getnode (readHeap var6 var2))))) (is-O_node (readHeap var6 var2)))) (inv_main50 var6 var5 var4 var3 var2 var1 var0))))
