...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 Heap)) (or (not (and (batchAllocPostHeap emptyHeap var3 (O_Int var2) 5) (and (and (and (= var1 (AddrRange (ite (<= 0 4) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 5)) true) (= var4 emptyHeap)) (= var0 0)))) (inv_main4 var3 var1 var0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 Heap)) (or (not (and (and (and (= var1 (AddrRange (ite (<= 0 4) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 5)) true) (= var4 emptyHeap)) (= var0 0))) (batchAllocHeap emptyHeap emptyHeap (O_Int var2) 5 5))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 AddrRange) (var5 Heap) (var6 Int) (var7 Int) (var8 Int) (var9 AddrRange) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main10 var10 var9 var8 var7 var6) (= var0 (+ var3 1))) (= var1 var6)) (= var2 var7)) (= var3 var8)) (= var4 var9)) (= var5 (writeHeap var10 (nthAddrRange var9 var8) (O_Int 0)))) (is-O_Int (readHeap var10 (nthAddrRange var9 var8)))) (is-O_Int (readHeap var10 (nthAddrRange var9 var8))))) (inv_main7 var5 var4 var0 var2 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 Int) (var4 AddrRange) (var5 Heap)) (or (not (and (and (and (inv_main7 var5 var4 var3 var2 var1) (= var0 0)) (not (= var2 0))) (= var3 4))) (inv_main10 var5 var4 var0 var2 var1))))
