...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 S) (var4 Heap) (var5 Heap)) (or (not (and (batchAllocPostHeap emptyHeap var4 (O_S var3) 100000) (and (and (= var5 emptyHeap) (= var2 (AddrRange (ite (<= 0 99999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 100000))) true))) (inv_main5 var4 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap)) (or (not (and (and (and (inv_main24 var4 var3 var2 var1) (= var0 (+ var2 1))) (<= 0 (+ (+ (* (- 1) var2) 100000) (* (- 1) 1)))) (not (= var1 0)))) (inv_main24 var4 var3 var0 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 Heap) (var5 Addr) (var6 Int) (var7 Int) (var8 Int) (var9 AddrRange) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (and (and (inv_main18 var10 var9 var8 var7) (= var0 1)) (= var1 (+ var6 1))) (= var5 (n (getS (readHeap var10 (nthAddrRange var9 var8)))))) (= var2 var7)) (= var6 var8)) (= var3 var9)) (= var4 var10)) (is-O_S (readHeap var10 (nthAddrRange var9 var8)))) (not (= var5 nullAddr))) (<= 0 (+ (+ (* (- 1) (+ var6 1)) 100000) (* (- 1) 1))))) (inv_main18 var4 var3 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap) (var4 Addr) (var5 Int) (var6 Int) (var7 Int) (var8 AddrRange) (var9 Heap)) (or (not (and (and (and (and (and (and (and (and (and (inv_main18 var9 var8 var7 var6) (= var0 (+ var5 1))) (= var4 (n (getS (readHeap var9 (nthAddrRange var8 var7)))))) (= var1 var6)) (= var5 var7)) (= var2 var8)) (= var3 var9)) (is-O_S (readHeap var9 (nthAddrRange var8 var7)))) (= var4 nullAddr)) (<= 0 (+ (+ (* (- 1) (+ var5 1)) 100000) (* (- 1) 1))))) (inv_main18 var3 var2 var0 var1))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Int) (var4 Int) (var5 Heap) (var6 Int) (var7 Int) (var8 AddrRange) (var9 Heap)) (or (not (and (and (and (and (and (inv_main5 var9 var8 var7 var6) (= var0 (newAddr (allocHeap var9 (O_Int var4))))) (= var1 0)) (= var2 100000)) (= var3 0)) (= var5 (newHeap (allocHeap var9 (O_Int var4)))))) (inv_main15 var5 var8 var7 var3 var8 var2 var1 var0))))
