...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 AddrRange) (var4 Heap) (var5 Int) (var6 AddrRange) (var7 AddrRange) (var8 Heap)) (or (not (and (and (and (and (and (and (and (inv_main7 var8 var7 var6 var5) (= var0 (+ var1 1))) (= var1 var5)) (= var2 var6)) (= var3 var7)) (= var4 (writeHeap var8 (nthAddrRange var7 var5) (O_Int 42)))) (is-O_Int (readHeap var8 (nthAddrRange var7 var5)))) (is-O_Int (readHeap var8 (nthAddrRange var7 var5))))) (inv_main5 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 AddrRange) (var4 AddrRange) (var5 Heap)) (or (not (and (and (and (inv_main17 var5 var4 var3 var2 var1) (= var0 (+ var1 1))) (is-O_Int (readHeap var5 (nthAddrRange var3 var1)))) (<= 0 (+ (+ (* (- 1) (+ var1 1)) 100000) (* (- 1) 1))))) (inv_main17 var5 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 AddrRange) (var4 Heap) (var5 Int) (var6 Int) (var7 Int) (var8 AddrRange) (var9 AddrRange) (var10 Heap)) (or (not (and (and (and (and (and (and (and (and (and (inv_main13 var10 var9 var8 var7 var6) (= var0 0)) (= var1 (+ var5 1))) (= var5 var7)) (= var2 var8)) (= var3 var9)) (= var4 (writeHeap var10 (nthAddrRange var8 var7) (O_Int var6)))) (is-O_Int (readHeap var10 (nthAddrRange var8 var7)))) (is-O_Int (readHeap var10 (nthAddrRange var8 var7)))) (not (<= 0 (+ (+ (* (- 1) (+ var5 1)) 100000) (* (- 1) 1)))))) (inv_main17 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 AddrRange) (var4 Heap)) (or (not (and (and (inv_main5 var4 var3 var2 var1) (= var0 0)) (not (<= 0 (+ (+ (* (- 1) var1) 100000) (* (- 1) 1)))))) (inv_main11 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 AddrRange) (var3 Heap) (var4 Int) (var5 Int) (var6 Int) (var7 AddrRange) (var8 AddrRange) (var9 Heap)) (or (not (and (and (and (and (and (and (and (and (inv_main13 var9 var8 var7 var6 var5) (= var0 (+ var4 1))) (= var4 var6)) (= var1 var7)) (= var2 var8)) (= var3 (writeHeap var9 (nthAddrRange var7 var6) (O_Int var5)))) (is-O_Int (readHeap var9 (nthAddrRange var7 var6)))) (is-O_Int (readHeap var9 (nthAddrRange var7 var6)))) (<= 0 (+ (+ (* (- 1) (+ var4 1)) 100000) (* (- 1) 1))))) (inv_main11 var3 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 AddrRange) (var4 Heap)) (or (not (and (and (inv_main11 var4 var3 var2 var1) (= var0 (getInt (readHeap var4 (nthAddrRange var3 var1))))) (is-O_Int (readHeap var4 (nthAddrRange var3 var1))))) (inv_main13 var4 var3 var2 var1 var0))))
