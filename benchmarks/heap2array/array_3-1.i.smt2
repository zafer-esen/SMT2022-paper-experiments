...
(assert (forall ((var0 AddrRange) (var1 Heap) (var2 Int) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (and (and (and (and (and (and (inv_main11 var6 var5 var4) (= var2 (getInt (readHeap var6 (nthAddrRange var5 var4))))) (= var3 var4)) (= var0 var5)) (= var1 var6)) (is-O_Int (readHeap var6 (nthAddrRange var5 var4)))) (not (= var2 0))) (<= 0 (+ var3 (* (- 1) 1023))))) (inv_main10 var1 var0 var3))))
