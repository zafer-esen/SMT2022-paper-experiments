...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap)) (or (not (and (batchAllocPostHeap emptyHeap var2 (O__S (_S 0)) 100000) (and true (= var1 (AddrRange (ite (<= 0 99999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 100000))))) (inv_main3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (and (and (and (and (and (and (inv_main6 var6 var5 var4) (= var0 (+ var3 1))) (= var3 var4)) (= var1 var5)) (= var2 (writeHeap var6 (nthAddrRange var5 var4) (O__S (_S 10))))) (is-O__S (readHeap var6 (nthAddrRange var5 var4)))) (is-O__S (readHeap var6 (nthAddrRange var5 var4)))) (<= 0 (+ (+ (* (- 1) (+ var3 1)) 100000) (* (- 1) 1))))) (inv_main6 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (and (and (and (and (and (and (inv_main6 var6 var5 var4) (= var0 0)) (= var3 var4)) (= var1 var5)) (= var2 (writeHeap var6 (nthAddrRange var5 var4) (O__S (_S 10))))) (is-O__S (readHeap var6 (nthAddrRange var5 var4)))) (is-O__S (readHeap var6 (nthAddrRange var5 var4)))) (not (<= 0 (+ (+ (* (- 1) (+ var3 1)) 100000) (* (- 1) 1)))))) (inv_main10 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 Int) (var5 Int) (var6 AddrRange) (var7 Heap)) (or (not (and (and (and (and (and (and (and (inv_main15 var7 var6 var5 var4) (= var0 (+ var3 1))) (= var3 var5)) (= var1 var6)) (= var2 (writeHeap var7 (nthAddrRange var6 (+ var4 1)) (O__S (_S 20))))) (is-O__S (readHeap var7 (nthAddrRange var6 (+ var4 1))))) (is-O__S (readHeap var7 (nthAddrRange var6 (+ var4 1))))) (<= 0 (+ (+ (* (- 1) (+ var3 1)) 100000) (* (- 1) 1))))) (inv_main10 var2 var1 var0))))
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (and (and (and (inv_main10 var3 var2 var1) (= var0 (+ var1 1))) (is-O__S (readHeap var3 (nthAddrRange var2 var1)))) (= (+ var1 1) 15000)) (<= 0 (+ (+ (* (- 1) (+ var1 1)) 100000) (* (- 1) 1))))) (inv_main10 var3 var2 var0))))
