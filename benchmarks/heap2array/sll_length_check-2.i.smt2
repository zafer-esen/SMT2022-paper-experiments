...
(assert (forall ((var0 Addr) (var1 Int) (var2 Heap)) (or (not (and (and (inv_main3 var2 var1) (= var0 nullAddr)) (not (<= 0 (+ (+ (* (- 1) var1) 32) (* (- 1) 1)))))) (inv_main11 var2 var1 var1 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Heap)) (or (not (and (and (and (inv_main3 var3 var2) (= var0 nullAddr)) (<= 0 (+ (+ (* (- 1) var2) 32) (* (- 1) 1)))) (= var1 0))) (inv_main11 var3 var2 var2 var0))))
