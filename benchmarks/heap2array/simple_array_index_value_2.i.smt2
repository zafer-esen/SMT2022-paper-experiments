...
(assert (forall ((var0 AddrRange) (var1 Int) (var2 Heap) (var3 Heap) (var4 Int)) (or (not (and (batchAllocPostHeap emptyHeap var2 (O_UInt var1) 10000) (and (and (and (= var3 emptyHeap) (<= 0 var4)) (= var0 (AddrRange (ite (<= 0 9999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 10000))) true))) (inv_main4 var2 var0 var4))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 AddrRange) (var3 Heap)) (or (not (and (and (and (inv_main18 var3 var2 var1) (= var0 (+ var1 1))) (is-O_UInt (readHeap var3 (nthAddrRange var2 var1)))) (<= 0 (+ (+ (* (- 1) (+ var1 1)) 10000) (* (- 1) 1))))) (inv_main18 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 Int) (var5 Int) (var6 AddrRange) (var7 Heap)) (or (not (and (and (and (and (and (and (and (inv_main11 var7 var6 var5 var4) (= var0 0)) (= var3 var5)) (= var1 var6)) (= var2 (writeHeap var7 (nthAddrRange var6 var5) (O_UInt var4)))) (is-O_UInt (readHeap var7 (nthAddrRange var6 var5)))) (is-O_UInt (readHeap var7 (nthAddrRange var6 var5)))) (not (<= 0 (+ (+ (* (- 1) (+ var3 1)) 10000) (* (- 1) 1)))))) (inv_main18 var2 var1 var0))))
