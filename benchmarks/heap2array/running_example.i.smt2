...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main4 var4 var3 var2 var1) (= var0 (writeHeap var4 var2 (O_node (node (val (getnode (readHeap var4 var2))) nullAddr))))) (is-O_node (readHeap var4 var2))) (is-O_node (readHeap var4 var2)))) (inv_main5 var0 var3 var2 var1))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (inv_main22 var4 var3 var2 var1) (= var0 (val (getnode (readHeap var4 var3))))) (is-O_node (readHeap var4 var3)))) (inv_main27 var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main5 var4 var3 var2 var1) (= var0 (writeHeap var4 var2 (O_node (node 10 (next (getnode (readHeap var4 var2)))))))) (is-O_node (readHeap var4 var2))) (is-O_node (readHeap var4 var2)))) (inv_main6 var0 var3 var2 var1))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (inv_main31 var4 var3 var2 var1) (= var0 (val (getnode (readHeap var4 var3))))) (is-O_node (readHeap var4 var3)))) (inv_main34 var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Int) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (and (inv_main33 var5 var4 var3 var2 var1) (= var0 (writeHeap var5 var4 (O_node (node (+ var1 1) (next (getnode (readHeap var5 var4)))))))) (is-O_node (readHeap var5 var4)))) (inv_main23 var0 var4 var3 var2))))
(assert (forall ((var0 Heap) (var1 Int) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Int)) (or (not (and (and (and (and (and (and (inv_main34 var5 var4 var3 var2 var1) (= var0 (writeHeap var5 var4 (O_node (node var6 (next (getnode (readHeap var5 var4)))))))) (or (not (<= 0 (+ (* (- 1) (+ var1 (* (- 2) var6))) (* (- 1) 1)))) (<= 0 (+ (* (- 1) var1) (* (- 1) 1))))) (or (not (<= 0 (+ (+ (* (- 2) var6) var1) (* (- 1) 1)))) (<= 0 (+ var1 (* (- 1) 1))))) (<= 0 (+ (+ (* 1 (+ var1 (* (- 2) var6))) 2) (* (- 1) 1)))) (<= 0 (+ (+ (* (- 1) (+ var1 (* (- 2) var6))) 2) (* (- 1) 1)))) (is-O_node (readHeap var5 var4)))) (inv_main23 var0 var4 var3 var2))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (inv_main30 var4 var3 var2 var1) (= var0 (val (getnode (readHeap var4 var3))))) (is-O_node (readHeap var4 var3)))) (inv_main33 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Heap) (var1 Int) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (and (and (inv_main17 var5 var4 var3 var2 var1) (= var0 (writeHeap var5 var4 (O_node (node (val (getnode (readHeap var5 var4))) nullAddr))))) (is-O_node (readHeap var5 var4))) (is-O_node (readHeap var5 var4)))) (inv_main18 var0 var4 var3 var2 var1))))
(assert (forall ((var0 Heap) (var1 Int) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (and (and (inv_main15 var5 var4 var3 var2 var1) (= var0 (writeHeap var5 var2 (O_node (node (val (getnode (readHeap var5 var2))) var4))))) (is-O_node (readHeap var5 var2))) (is-O_node (readHeap var5 var2)))) (inv_main17 var0 var4 var3 var2 var1))))
