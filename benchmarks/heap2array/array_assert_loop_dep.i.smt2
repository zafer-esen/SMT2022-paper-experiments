...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 Heap)) (or (not (and (batchAllocPostHeap emptyHeap var3 (O_Int var2) 100000) (and (and true (= var4 emptyHeap)) (= var1 (AddrRange (ite (<= 0 99999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 100000))))) (inv_main4 var3 var0 var1))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Int) (var3 Heap) (var4 Heap)) (or (not (and (and true (= var4 emptyHeap)) (= var1 (AddrRange (ite (<= 0 99999) (+ (HeapSize emptyHeap) 1) (HeapSize emptyHeap)) 100000)))) (batchAllocHeap emptyHeap emptyHeap (O_Int var2) 100000 100000))))
...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 AddrRange) (var5 Int) (var6 Heap)) (or (not (and (and (and (and (and (and (and (inv_main7 var6 var5 var4) (= var0 0)) (= var1 var4)) (= var3 var5)) (= var2 (writeHeap var6 (nthAddrRange var4 var5) (O_Int 10)))) (is-O_Int (readHeap var6 (nthAddrRange var4 var5)))) (is-O_Int (readHeap var6 (nthAddrRange var4 var5)))) (not (<= 0 (+ (+ (* (- 1) (+ var3 1)) 100000) (* (- 1) 1)))))) (inv_main11 var2 var0 var1))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 AddrRange) (var5 Int) (var6 Heap)) (or (not (and (and (and (and (and (and (and (inv_main14 var6 var5 var4) (= var0 (+ var3 1))) (= var1 var4)) (= var3 var5)) (= var2 (writeHeap var6 (nthAddrRange var4 (+ var5 1)) (O_Int 20)))) (is-O_Int (readHeap var6 (nthAddrRange var4 (+ var5 1))))) (is-O_Int (readHeap var6 (nthAddrRange var4 (+ var5 1))))) (<= 0 (+ (+ (* (- 1) (+ var3 1)) 100000) (* (- 1) 1))))) (inv_main11 var2 var0 var1))))
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Int) (var3 Heap)) (or (not (and (and (and (and (inv_main11 var3 var2 var1) (= var0 (+ var2 1))) (is-O_Int (readHeap var3 (nthAddrRange var1 var2)))) (= (+ var2 1) 15000)) (<= 0 (+ (+ (* (- 1) (+ var2 1)) 100000) (* (- 1) 1))))) (inv_main11 var3 var0 var1))))
...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 AddrRange) (var5 Int) (var6 Heap)) (or (not (and (and (and (and (and (and (and (inv_main7 var6 var5 var4) (= var0 (+ var3 1))) (= var1 var4)) (= var3 var5)) (= var2 (writeHeap var6 (nthAddrRange var4 var5) (O_Int 10)))) (is-O_Int (readHeap var6 (nthAddrRange var4 var5)))) (is-O_Int (readHeap var6 (nthAddrRange var4 var5)))) (<= 0 (+ (+ (* (- 1) (+ var3 1)) 100000) (* (- 1) 1))))) (inv_main7 var2 var0 var1))))
