...
(assert (forall ((var0 Addr) (var1 node) (var2 Heap) (var3 Int) (var4 Int) (var5 Addr) (var6 Heap)) (or (not (and (and (and (and (inv_main3 var6 var5) (= var0 (newAddr (allocHeap var6 (O_node var1))))) (= var2 (newHeap (allocHeap var6 (O_node var1))))) (not (= var3 0))) (not (<= 0 (+ (* (- 1) var4) (* (- 1) 1)))))) (inv_main12 var2 var5 var4 var0))))
(assert (forall ((var0 Heap) (var1 Int) (var2 Int) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (and (and (inv_main28 var5 var4 var3 var2 var1) (= var0 (writeHeap var5 var3 (O_node (node (next (getnode (readHeap var5 var3))) var1 (order (getnode (readHeap var5 var3)))))))) (is-O_node (readHeap var5 var3))) (is-O_node (readHeap var5 var3)))) (inv_main27 var0 var4 var3 var2))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (inv_main26 var4 var3 var2 var1) (= var0 (stock (getnode (readHeap var4 var2))))) (is-O_node (readHeap var4 var2)))) (inv_main28 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Int) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main12 var4 var3 var2 var1) (= var0 (writeHeap var4 var1 (O_node (node (next (getnode (readHeap var4 var1))) var2 (order (getnode (readHeap var4 var1)))))))) (is-O_node (readHeap var4 var1))) (is-O_node (readHeap var4 var1)))) (inv_main13 var0 var3 var2 var1))))
...
(assert (forall ((var0 Heap) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main21 var4 var3 var2 var1) (= var0 (writeHeap var4 var2 (O_node (node (next (getnode (readHeap var4 var2))) (stock (getnode (readHeap var4 var2))) var1))))) (is-O_node (readHeap var4 var2))) (is-O_node (readHeap var4 var2)))) (inv_main26 var0 var3 var2 var1))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Int) (var3 Addr) (var4 Heap)) (or (not (and (and (and (inv_main13 var4 var3 var2 var1) (= var0 (writeHeap var4 var1 (O_node (node (next (getnode (readHeap var4 var1))) (stock (getnode (readHeap var4 var1))) 0))))) (is-O_node (readHeap var4 var1))) (is-O_node (readHeap var4 var1)))) (inv_main14 var0 var3 var2 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (and (inv_main31 var3 var2 var1) (= var0 (order (getnode (readHeap var3 var1))))) (is-O_node (readHeap var3 var1)))) (inv_main35 var3 var2 var1 var0))))
