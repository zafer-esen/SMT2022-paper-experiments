...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (and (and (inv_main14 var3 var2 var1) (= var0 (writeHeap var3 var1 (O_TSLL (TSLL nullAddr (data (getTSLL (readHeap var3 var1)))))))) (is-O_TSLL (readHeap var3 var1))) (is-O_TSLL (readHeap var3 var1)))) (inv_main6 var0 var2 var1))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (and (and (and (inv_main32 var4 var3 var2 var1) (= var0 (writeHeap var4 (next (getTSLL (readHeap var4 var2))) (O_TSLL (TSLL (next (getTSLL (readHeap var4 (next (getTSLL (readHeap var4 var2)))))) 1))))) (is-O_TSLL (readHeap var4 (next (getTSLL (readHeap var4 var2)))))) (is-O_TSLL (readHeap var4 (next (getTSLL (readHeap var4 var2)))))) (is-O_TSLL (readHeap var4 var2)))) (inv_main34 var0 var3 var2 var1))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (and (and (inv_main33 var5 var4 var3 var2 var1) (= var0 (writeHeap var5 var3 (O_TSLL (TSLL var1 (data (getTSLL (readHeap var5 var3)))))))) (is-O_TSLL (readHeap var5 var3))) (is-O_TSLL (readHeap var5 var3)))) (inv_main32 var0 var4 var3 var2))))
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (and (and (and (and (and (and (inv_main24 var9 var8 var7) (= var0 (newAddr (allocHeap var6 (O_TSLL var1))))) (= var2 (newHeap (allocHeap var6 (O_TSLL var1))))) (= var3 (next (getTSLL (readHeap var9 var7))))) (= var4 var7)) (= var5 var8)) (= var6 var9)) (is-O_TSLL (readHeap var9 var7)))) (inv_main33 var2 var5 var4 var3 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (and (and (inv_main19 var3 var2 var1) (= var0 (writeHeap var3 var1 (O_TSLL (TSLL (next (getTSLL (readHeap var3 var1))) 1))))) (is-O_TSLL (readHeap var3 var1))) (is-O_TSLL (readHeap var3 var1)))) (inv_main21 var0 var2 var1))))
