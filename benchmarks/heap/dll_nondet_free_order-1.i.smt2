...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 node) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Int) (var11 Int) (var12 Heap)) (or (not (and (inv_main16 var12 var11 var10 var9 var8) (and (and (and (= nullAddr var7) (and (and (and (and (and (= var6 (newHeap (alloc var12 (O_node var5)))) (= var4 var11)) (= var3 var10)) (= var2 var9)) (= var1 var8)) (= var7 (newAddr (alloc var12 (O_node var5)))))) (<= 0 (+ (+ var10 (- 1)) (- 1)))) (= var0 1)))) (inv_main23 var6 var4 var3 var2 var1 var7 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap)) (or (not (and (inv_main8 var4 var3 var2 var1) (and (and (is-O_node (read var4 var1)) (is-O_node (read var4 var1))) (= var0 (write var4 var1 (O_node (node var1 (prev (getnode (read var4 var1)))))))))) (inv_main14 var0 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Int) (var4 Heap)) (or (not (and (inv_main33 var4 var3 var2 var1) (and (is-O_node (read var4 var1)) (= var0 (prev (getnode (read var4 var1))))))) (inv_main36 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main17 var5 var4 var3 var2 var1) (and (and (is-O_node (read var5 var2)) (is-O_node (read var5 var2))) (= var0 (write var5 var2 (O_node (node var1 (prev (getnode (read var5 var2)))))))))) (inv_main29 var0 var4 var3 var2 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Int) (var3 node) (var4 Heap) (var5 Addr) (var6 Int) (var7 Heap)) (or (not (and (inv_main3 var7 var6) (and (and (= nullAddr var5) (and (and (and (= var4 (newHeap (alloc var7 (O_node var3)))) (= var2 var6)) (= var1 var6)) (= var5 (newAddr (alloc var7 (O_node var3)))))) (= var0 1)))) (inv_main11 var4 var2 var1 var5 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap)) (or (not (and (inv_main20 var6 var5 var4 var3 var2 var1) (and (and (is-O_node (read var6 var1)) (is-O_node (read var6 var1))) (= var0 (write var6 var1 (O_node (node var2 (prev (getnode (read var6 var1)))))))))) (inv_main26 var0 var5 var4 var3 var2 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Int) (var5 Int) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Addr) (var10 Int) (var11 Int) (var12 Heap)) (or (not (and (inv_main26 var12 var11 var10 var9 var8 var7) (and (and (and (is-O_node (read var12 var8)) (is-O_node (read var12 var8))) (and (and (and (and (and (= var6 (write var12 var8 (O_node (node (next (getnode (read var12 var8))) var7)))) (= var5 var11)) (= var4 var10)) (= var3 var9)) (= var2 var8)) (= var1 var7))) (= var0 (+ var4 (- 1)))))) (inv_main16 var6 var5 var0 var3 var1))))
