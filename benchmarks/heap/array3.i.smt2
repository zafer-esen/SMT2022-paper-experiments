...
(assert (forall ((var0 Int) (var1 AddrRange) (var2 Heap) (var3 Int) (var4 Int) (var5 Int) (var6 AddrRange) (var7 Heap)) (or (not (and (inv_main11 var7 var6 var5) (and (and (not (<= 0 (+ var4 (- 1024)))) (and (and (not (= var3 0)) (is-O_Int (read var7 (nthAddrRange var6 var5)))) (and (and (and (= var2 var7) (= var1 var6)) (= var4 var5)) (= var3 (getInt (read var7 (nthAddrRange var6 var5))))))) (= var0 (+ var4 1))))) (inv_main11 var2 var1 var0))))
...
(assert (forall ((var0 AddrRange) (var1 Heap) (var2 Int) (var3 Int) (var4 Int) (var5 AddrRange) (var6 Heap)) (or (not (and (inv_main11 var6 var5 var4) (and (<= 0 (+ var3 (- 1024))) (and (and (not (= var2 0)) (is-O_Int (read var6 (nthAddrRange var5 var4)))) (and (and (and (= var1 var6) (= var0 var5)) (= var3 var4)) (= var2 (getInt (read var6 (nthAddrRange var5 var4))))))))) (inv_main10 var1 var0 var3))))
