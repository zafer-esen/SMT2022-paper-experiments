...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Int) (var4 Heap)) (or (not (and (inv_main40 var4 var3 var2 var1) (and (is-O_node (read var4 var2)) (or (and (not (= 0 (data_0 (getnode (read var4 var2))))) (= var0 1)) (and (= 0 (data_0 (getnode (read var4 var2)))) (= var0 0)))))) (inv_main44 var4 var3 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Int) (var9 Int) (var10 Heap)) (or (not (and (inv_main23 var10 var9 var8 var7 var6) (and (and (and (is-O_node (read var10 var7)) (is-O_node (read var10 var7))) (and (and (and (and (= var5 (write var10 var7 (O_node (node (data_0 (getnode (read var10 var7))) (next (getnode (read var10 var7))) (data_1 (getnode (read var10 var7))) var6 (data_2 (getnode (read var10 var7))))))) (= var4 var9)) (= var3 var8)) (= var2 var7)) (= var1 var6))) (= var0 (+ var3 (- 1)))))) (inv_main7 var5 var4 var0 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap) (var5 Addr) (var6 Addr) (var7 Addr) (var8 Int) (var9 Int) (var10 Heap)) (or (not (and (inv_main20 var10 var9 var8 var7 var6) (and (and (and (= var5 nullAddr) (and (is-O_node (read var10 var6)) (is-O_node (read var10 var6)))) (and (and (and (and (= var4 (write var10 var6 (O_node (node (data_0 (getnode (read var10 var6))) (next (getnode (read var10 var6))) (data_1 (getnode (read var10 var6))) nullAddr (data_2 (getnode (read var10 var6))))))) (= var3 var9)) (= var2 var8)) (= var5 var7)) (= var1 var6))) (= var0 (+ var2 (- 1)))))) (inv_main7 var4 var3 var0 var1))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Heap)) (or (not (and (inv_main3 var2 var1) (= var0 nullAddr))) (inv_main7 var2 var1 var1 var0))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Heap)) (or (not (and (inv_main39 var3 var2 var1) (and (is-O_node (read var3 var1)) (= var0 (prev (getnode (read var3 var1))))))) (inv_main40 var3 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main19 var5 var4 var3 var2 var1) (and (and (is-O_node (read var5 var1)) (is-O_node (read var5 var1))) (= var0 (write var5 var1 (O_node (node (data_0 (getnode (read var5 var1))) var2 (data_1 (getnode (read var5 var1))) (prev (getnode (read var5 var1))) (data_2 (getnode (read var5 var1)))))))))) (inv_main20 var0 var4 var3 var2 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Int) (var3 Heap)) (or (not (and (inv_main28 var3 var2 var1) (and (is-O_node (read var3 var1)) (or (and (not (= 0 (data_0 (getnode (read var3 var1))))) (= var0 1)) (and (= 0 (data_0 (getnode (read var3 var1)))) (= var0 0)))))) (inv_main32 var3 var2 var1 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main17 var5 var4 var3 var2 var1) (and (and (is-O_node (read var5 var1)) (is-O_node (read var5 var1))) (= var0 (write var5 var1 (O_node (node (data_0 (getnode (read var5 var1))) (next (getnode (read var5 var1))) 0 (prev (getnode (read var5 var1))) (data_2 (getnode (read var5 var1)))))))))) (inv_main18 var0 var4 var3 var2 var1))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Int) (var5 Heap)) (or (not (and (inv_main44 var5 var4 var3 var2 var1) (and (not (= var1 0)) (= var0 1)))) (inv_main46 var5 var4 var3 var2 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Int) (var4 Heap)) (or (not (and (inv_main32 var4 var3 var2 var1) (and (not (= var1 0)) (= var0 1)))) (inv_main34 var4 var3 var2 var0))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Int) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Int) (var8 Int) (var9 Heap)) (or (not (and (inv_main20 var9 var8 var7 var6 var5) (and (and (not (= var4 nullAddr)) (and (is-O_node (read var9 var5)) (is-O_node (read var9 var5)))) (and (and (and (and (= var3 (write var9 var5 (O_node (node (data_0 (getnode (read var9 var5))) (next (getnode (read var9 var5))) (data_1 (getnode (read var9 var5))) nullAddr (data_2 (getnode (read var9 var5))))))) (= var2 var8)) (= var1 var7)) (= var4 var6)) (= var0 var5))))) (inv_main23 var3 var2 var1 var4 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Int) (var4 Int) (var5 Heap)) (or (not (and (inv_main18 var5 var4 var3 var2 var1) (and (and (is-O_node (read var5 var1)) (is-O_node (read var5 var1))) (= var0 (write var5 var1 (O_node (node (data_0 (getnode (read var5 var1))) (next (getnode (read var5 var1))) (data_1 (getnode (read var5 var1))) (prev (getnode (read var5 var1))) 0))))))) (inv_main19 var0 var4 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap)) (not (and (inv_main18 var4 var3 var2 var1 var0) (and (is-O_node (read var4 var0)) (not (is-O_node (read var4 var0))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap)) (not (and (inv_main20 var4 var3 var2 var1 var0) (and (is-O_node (read var4 var0)) (not (is-O_node (read var4 var0))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Int) (var3 Int) (var4 Heap)) (not (and (inv_main23 var4 var3 var2 var1 var0) (and (is-O_node (read var4 var1)) (not (is-O_node (read var4 var1))))))))
