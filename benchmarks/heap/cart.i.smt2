...
(assert (forall ((var0 Addr) (var1 node) (var2 Heap) (var3 Int) (var4 Int) (var5 Addr) (var6 Heap)) (or (not (and (inv_main3 var6 var5) (and (and (and (not (<= 0 (+ (* (- 1) var4) (- 1)))) (not (= var3 0))) (= var2 (newHeap (alloc var6 (O_node var1))))) (= var0 (newAddr (alloc var6 (O_node var1))))))) (inv_main12 var2 var5 var4 var0))))
(assert (forall ((var0 Heap) (var1 Int) (var2 Int) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main28 var5 var4 var3 var2 var1) (and (and (is-O_node (read var5 var3)) (is-O_node (read var5 var3))) (= var0 (write var5 var3 (O_node (node (next (getnode (read var5 var3))) var1 (order (getnode (read var5 var3)))))))))) (inv_main27 var0 var4 var3 var2))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main26 var4 var3 var2 var1) (and (is-O_node (read var4 var2)) (= var0 (stock (getnode (read var4 var2))))))) (inv_main28 var4 var3 var2 var1 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Int) (var3 Addr) (var4 Heap)) (or (not (and (inv_main12 var4 var3 var2 var1) (and (and (is-O_node (read var4 var1)) (is-O_node (read var4 var1))) (= var0 (write var4 var1 (O_node (node (next (getnode (read var4 var1))) var2 (order (getnode (read var4 var1)))))))))) (inv_main13 var0 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Int) (var6 Addr) (var7 Heap)) (or (not (and (inv_main14 var7 var6 var5 var4) (and (and (is-O_node (read var7 var4)) (is-O_node (read var7 var4))) (and (and (and (= var3 (write var7 var4 (O_node (node var6 (stock (getnode (read var7 var4))) (order (getnode (read var7 var4))))))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main3 var3 var0))))
...
(assert (forall ((var0 Heap) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main21 var4 var3 var2 var1) (and (and (is-O_node (read var4 var2)) (is-O_node (read var4 var2))) (= var0 (write var4 var2 (O_node (node (next (getnode (read var4 var2))) (stock (getnode (read var4 var2))) var1))))))) (inv_main26 var0 var3 var2 var1))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Int) (var3 Addr) (var4 Heap)) (or (not (and (inv_main13 var4 var3 var2 var1) (and (and (is-O_node (read var4 var1)) (is-O_node (read var4 var1))) (= var0 (write var4 var1 (O_node (node (next (getnode (read var4 var1))) (stock (getnode (read var4 var1))) 0))))))) (inv_main14 var0 var3 var2 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main31 var3 var2 var1) (and (is-O_node (read var3 var1)) (= var0 (order (getnode (read var3 var1))))))) (inv_main35 var3 var2 var1 var0))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (not (and (inv_main12 var3 var2 var1 var0) (not (is-O_node (read var3 var0)))))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (not (and (inv_main12 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (not (is-O_node (read var3 var0))))))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (not (and (inv_main13 var3 var2 var1 var0) (not (is-O_node (read var3 var0)))))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (not (and (inv_main13 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (not (is-O_node (read var3 var0))))))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (not (and (inv_main14 var3 var2 var1 var0) (not (is-O_node (read var3 var0)))))))
(assert (forall ((var0 Addr) (var1 Int) (var2 Addr) (var3 Heap)) (not (and (inv_main14 var3 var2 var1 var0) (and (is-O_node (read var3 var0)) (not (is-O_node (read var3 var0))))))))
...
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main21 var3 var2 var1 var0) (and (is-O_node (read var3 var1)) (not (is-O_node (read var3 var1))))))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main28 var4 var3 var2 var1 var0) (and (is-O_node (read var4 var2)) (not (is-O_node (read var4 var2))))))))
