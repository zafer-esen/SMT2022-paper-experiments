...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main112 var6 var5 var4) (and (and (and (is-O_TSLL (read var6 var4)) (= nullAddr (next (getTSLL (read var6 var4))))) (and (and (= var3 (write var6 var4 defObj)) (= var2 var5)) (= var1 var4))) (= var0 nullAddr)))) (inv_main104 var3 var2 var0))))
