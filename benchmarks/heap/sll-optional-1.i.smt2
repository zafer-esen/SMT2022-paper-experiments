...
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Int) (var4 Addr) (var5 Addr) (var6 Heap)) (or (not (and (inv_main17 var6 var5 var4) (and (and (not (= var3 0)) (= var2 (newHeap (alloc var6 (O_TSLL var1))))) (= var0 (newAddr (alloc var6 (O_TSLL var1))))))) (inv_main22 var2 var5 var4 var0))))
...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main44 var4 var3 var2 var1) (and (not (= var1 2)) (= var0 0)))) (inv_main46 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Int) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main44 var8 var7 var6 var5) (and (and (and (= var5 2) (is-O_TSLL (read var8 var6))) (and (and (and (= var4 var8) (= var3 var7)) (= var2 var6)) (= var1 (opt (getTSLL (read var8 var6)))))) (or (and (not (= var1 var2)) (= var0 1)) (and (= var1 var2) (= var0 0)))))) (inv_main46 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main39 var3 var2 var1) (and (is-O_TSLL (read var3 var1)) (= var0 (data (getTSLL (read var3 var1))))))) (inv_main44 var3 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main32 var3 var2 var1) (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))) (= var0 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) (opt (getTSLL (read var3 var1))) 1))))))) (inv_main35 var0 var2 var1))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Heap)) (or (not (and (inv_main13 var2 var1) (and (and (is-O_TSLL (read var2 var1)) (is-O_TSLL (read var2 var1))) (= var0 (write var2 var1 (O_TSLL (TSLL (next (getTSLL (read var2 var1))) (opt (getTSLL (read var2 var1))) 0))))))) (inv_main16 var0 var1))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main30 var3 var2 var1) (and (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 (opt (getTSLL (read var3 var1)))))) (is-O_TSLL (read var3 (opt (getTSLL (read var3 var1)))))) (= var0 (write var3 (opt (getTSLL (read var3 var1))) (O_TSLL (TSLL nullAddr (opt (getTSLL (read var3 (opt (getTSLL (read var3 var1)))))) (data (getTSLL (read var3 (opt (getTSLL (read var3 var1))))))))))))) (inv_main17 var0 var2 var1))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main35 var3 var2 var1) (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))) (= var0 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) var1 (data (getTSLL (read var3 var1)))))))))) (inv_main17 var0 var2 var1))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main36 var3 var2 var1) (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))) (= var0 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) var1 (data (getTSLL (read var3 var1)))))))))) (inv_main17 var0 var2 var1))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main22 var4 var3 var2 var1) (and (and (is-O_TSLL (read var4 var2)) (is-O_TSLL (read var4 var2))) (= var0 (write var4 var2 (O_TSLL (TSLL var1 (opt (getTSLL (read var4 var2))) (data (getTSLL (read var4 var2)))))))))) (inv_main21 var0 var3 var2))))
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Heap) (var5 Addr) (var6 Heap)) (or (not (and (inv_main6 var6 var5) (and (and (and (and (is-O_TSLL (read var6 var5)) (is-O_TSLL (read var6 var5))) (and (= var4 (write var6 var5 (O_TSLL (TSLL (next (getTSLL (read var6 var5))) (opt (getTSLL (read var6 var5))) 2)))) (= var3 var5))) (= var2 (newHeap (alloc var4 (O_TSLL var1))))) (= var0 (newAddr (alloc var4 (O_TSLL var1))))))) (inv_main11 var2 var3 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Heap)) (or (not (and (inv_main12 var2 var1) (and (and (is-O_TSLL (read var2 var1)) (is-O_TSLL (read var2 var1))) (= var0 (write var2 var1 (O_TSLL (TSLL (next (getTSLL (read var2 var1))) (opt (getTSLL (read var2 var1))) 1))))))) (inv_main15 var0 var1))))
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main26 var8 var7 var6) (and (and (and (and (is-O_TSLL (read var8 var6)) (is-O_TSLL (read var8 var6))) (and (and (= var5 (write var8 var6 (O_TSLL (TSLL (next (getTSLL (read var8 var6))) (opt (getTSLL (read var8 var6))) 2)))) (= var4 var7)) (= var3 var6))) (= var2 (newHeap (alloc var5 (O_TSLL var1))))) (= var0 (newAddr (alloc var5 (O_TSLL var1))))))) (inv_main31 var2 var4 var3 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main31 var4 var3 var2 var1) (and (and (is-O_TSLL (read var4 var2)) (is-O_TSLL (read var4 var2))) (= var0 (write var4 var2 (O_TSLL (TSLL (next (getTSLL (read var4 var2))) var1 (data (getTSLL (read var4 var2)))))))))) (inv_main30 var0 var3 var2))))
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main46 var4 var3 var2 var1) (and (= var1 0) (= var0 0)))) (inv_main48 var4 var3 var2 var0))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap) (var5 Int) (var6 Addr) (var7 Addr) (var8 Heap)) (or (not (and (inv_main46 var8 var7 var6 var5) (and (and (and (and (not (= var5 0)) (is-O_TSLL (read var8 var6))) (is-O_TSLL (read var8 (opt (getTSLL (read var8 var6)))))) (and (and (and (= var4 var8) (= var3 var7)) (= var2 var6)) (= var1 (next (getTSLL (read var8 (opt (getTSLL (read var8 var6))))))))) (or (and (= var1 nullAddr) (= var0 1)) (and (not (= var1 nullAddr)) (= var0 0)))))) (inv_main48 var4 var3 var2 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main11 var3 var2 var1) (and (and (is-O_TSLL (read var3 var2)) (is-O_TSLL (read var3 var2))) (= var0 (write var3 var2 (O_TSLL (TSLL (next (getTSLL (read var3 var2))) var1 (data (getTSLL (read var3 var2)))))))))) (inv_main10 var0 var2))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main33 var3 var2 var1) (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))) (= var0 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) (opt (getTSLL (read var3 var1))) 0))))))) (inv_main36 var0 var2 var1))))
