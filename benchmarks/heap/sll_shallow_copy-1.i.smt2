...
(assert (forall ((var0 Int) (var1 node) (var2 Addr) (var3 Addr) (var4 node) (var5 Heap) (var6 Heap) (var7 Addr) (var8 Heap)) (or (not (and (inv_main2 var8) (and (and (and (= nullAddr var7) (and (and (= var6 (newHeap (alloc var5 (O_node var4)))) (= var3 var2)) (= var7 (newAddr (alloc var5 (O_node var4)))))) (and (not (= nullAddr var2)) (and (= var5 (newHeap (alloc var8 (O_node var1)))) (= var2 (newAddr (alloc var8 (O_node var1))))))) (= var0 1)))) (inv_main22 var6 var3 var7 var0))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main16 var3 var2 var1) (and (and (is-O_node (read var3 var2)) (is-O_node (read var3 var2))) (= var0 (write var3 var2 (O_node (node var1))))))) (inv_main14 var0 var2))))
(assert (forall ((var0 node) (var1 Addr) (var2 Heap)) (or (not (and (inv_main14 var2 var1) (and (is-O_node (read var2 var1)) (= var0 (getnode (read var2 var1)))))) (inv_main26 var2 var1 var0))))
...
(assert (forall ((var0 Int) (var1 node) (var2 Heap) (var3 Addr) (var4 Heap)) (or (not (and (inv_main2 var4) (and (and (= nullAddr var3) (and (= var2 (newHeap (alloc var4 (O_node var1)))) (= var3 (newAddr (alloc var4 (O_node var1)))))) (= var0 1)))) (inv_main10 var2 var3 var0))))
(assert (forall ((var0 Heap) (var1 node) (var2 Addr) (var3 Heap)) (or (not (and (inv_main26 var3 var2 var1) (and (and (is-O_node (read var3 var2)) (is-O_node (read var3 var2))) (= var0 (write var3 var2 (O_node var1)))))) (inv_main25 var0 var2))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main16 var2 var1 var0) (not (is-O_node (read var2 var1)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main16 var2 var1 var0) (and (is-O_node (read var2 var1)) (not (is-O_node (read var2 var1))))))))
...
(assert (forall ((var0 node) (var1 Addr) (var2 Heap)) (not (and (inv_main26 var2 var1 var0) (and (is-O_node (read var2 var1)) (not (is-O_node (read var2 var1))))))))
