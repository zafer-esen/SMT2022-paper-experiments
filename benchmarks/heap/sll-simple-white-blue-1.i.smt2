...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main14 var5 var4 var3) (and (and (is-O_TSLL (read var5 var3)) (is-O_TSLL (read var5 var3))) (and (and (= var2 (write var5 var3 (O_TSLL (TSLL nullAddr (data (getTSLL (read var5 var3))))))) (= var1 var4)) (= var0 var3))))) (inv_main6 var2 var1 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main35 var4 var3 var2 var1) (and (and (is-O_TSLL (read var4 var2)) (is-O_TSLL (read var4 var2))) (= var0 (write var4 var2 (O_TSLL (TSLL (next (getTSLL (read var4 var2))) 1))))))) (inv_main37 var0 var3 var2 var1))))
(assert (forall ((var0 Int) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main61 var3 var2 var1) (and (= var1 nullAddr) (= var0 0)))) (inv_main0 var3 var0))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main36 var5 var4 var3 var2 var1) (and (and (is-O_TSLL (read var5 var3)) (is-O_TSLL (read var5 var3))) (= var0 (write var5 var3 (O_TSLL (TSLL var1 (data (getTSLL (read var5 var3)))))))))) (inv_main35 var0 var4 var3 var2))))
...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main20 var3 var2 var1) (and (and (is-O_TSLL (read var3 var1)) (is-O_TSLL (read var3 var1))) (= var0 (write var3 var1 (O_TSLL (TSLL (next (getTSLL (read var3 var1))) 1))))))) (inv_main22 var0 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 TSLL) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Addr) (var6 Heap) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main26 var9 var8 var7) (and (and (and (is-O_TSLL (read var9 var7)) (and (and (and (= var6 var9) (= var5 var8)) (= var4 var7)) (= var3 (next (getTSLL (read var9 var7)))))) (= var2 (newHeap (alloc var6 (O_TSLL var1))))) (= var0 (newAddr (alloc var6 (O_TSLL var1))))))) (inv_main36 var2 var5 var4 var3 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap) (var4 Addr) (var5 Addr) (var6 Addr) (var7 Heap)) (or (not (and (inv_main37 var7 var6 var5 var4) (and (and (is-O_TSLL (read var7 var5)) (is-O_TSLL (read var7 var5))) (and (and (and (= var3 (write var7 var5 (O_TSLL (TSLL var4 (data (getTSLL (read var7 var5))))))) (= var2 var6)) (= var1 var5)) (= var0 var4))))) (inv_main39 var3 var2 var2))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main22 var5 var4 var3) (and (and (is-O_TSLL (read var5 var3)) (is-O_TSLL (read var5 var3))) (and (and (= var2 (write var5 var3 (O_TSLL (TSLL var4 (data (getTSLL (read var5 var3))))))) (= var1 var4)) (= var0 var3))))) (inv_main39 var2 var0 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main20 var2 var1 var0) (and (is-O_TSLL (read var2 var0)) (not (is-O_TSLL (read var2 var0))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (not (and (inv_main36 var4 var3 var2 var1 var0) (and (is-O_TSLL (read var4 var2)) (not (is-O_TSLL (read var4 var2))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main35 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (not (is-O_TSLL (read var3 var1))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main37 var3 var2 var1 var0) (and (is-O_TSLL (read var3 var1)) (not (is-O_TSLL (read var3 var1))))))))
