...
(assert (forall ((var0 Int) (var1 Int) (var2 Addr) (var3 Addr) (var4 node) (var5 Heap) (var6 Addr) (var7 Addr) (var8 Addr) (var9 Heap)) (or (not (and (inv_main4 var9 var8 var7) (and (and (= var6 nullAddr) (and (and (and (and (= var5 (newHeap (alloc var9 (O_node var4)))) (= var3 var8)) (= var2 var7)) (= var6 (newAddr (alloc var9 (O_node var4))))) (not (= var1 0)))) (= var0 1)))) (inv_main13 var5 var6 var2 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main17 var5 var4 var3) (and (and (is-O_node (read var5 var4)) (is-O_node (read var5 var4))) (and (and (= var2 (write var5 var4 (O_node (node (h (getnode (read var5 var4))) var3)))) (= var1 var4)) (= var0 var3))))) (inv_main4 var2 var1 var1))))
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Heap)) (or (not (and (inv_main10 var3 var2 var1) (and (and (is-O_node (read var3 var2)) (is-O_node (read var3 var2))) (= var0 (write var3 var2 (O_node (node 1 (n (getnode (read var3 var2)))))))))) (inv_main17 var0 var2 var1))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main10 var2 var1 var0) (not (is-O_node (read var2 var1)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main10 var2 var1 var0) (and (is-O_node (read var2 var1)) (not (is-O_node (read var2 var1))))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main17 var2 var1 var0) (not (is-O_node (read var2 var1)))))))
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main17 var2 var1 var0) (and (is-O_node (read var2 var1)) (not (is-O_node (read var2 var1))))))))
