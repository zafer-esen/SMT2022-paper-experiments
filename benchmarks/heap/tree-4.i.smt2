...
(assert (forall ((var0 Heap) (var1 Addr) (var2 Addr) (var3 Addr) (var4 Heap)) (or (not (and (inv_main91 var4 var3 var2 var1) (and (is-O_node (read var4 var2)) (= var0 (write var4 (left (getnode (read var4 var2))) defObj))))) (inv_main90 var0 var3 var2 var1))))
...
(assert (forall ((var0 Addr) (var1 node) (var2 Heap) (var3 Addr) (var4 Addr) (var5 Heap)) (or (not (and (inv_main24 var5 var4 var3) (and (and (not (= var3 nullAddr)) (= var2 (newHeap (alloc var5 (O_node var1))))) (= var0 (newAddr (alloc var5 (O_node var1))))))) (inv_main30 var2 var4 var3 var0))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Heap)) (not (and (inv_main25 var2 var1 var0) (and (is-O_node (read var2 var0)) (not (is-O_node (read var2 var0))))))))
...
(assert (forall ((var0 Addr) (var1 Addr) (var2 Addr) (var3 Heap)) (not (and (inv_main30 var3 var2 var1 var0) (and (is-O_node (read var3 var1)) (not (is-O_node (read var3 var1))))))))
